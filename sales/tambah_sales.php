                  ...
                  <div class="card-body">
                     <form action="act_tambah.php" method="post">
                        <div class="mb-2">
                           ...
                           <input type="text" name="nama_sales" id="nama_sales" class="form-control" placeholder="Masukkan nama mobil" required>
                        </div>
                        <div class="mb-2">
                           <label for="alamat" class="form-label">Alamat</label>
                           <textarea name="alamat" id="alamat" rows="4" class="form-control" placeholder="Masukkan alamat"></textarea>
                        </div>
                        <div class="mb-2">
