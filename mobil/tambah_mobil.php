                  ...
                  <div class="card-body">
                     <form action="act_tambah.php" method="post">
                        <div class="mb-2">
                           ...
                           <input type="text" name="nama_mobil" id="nama_mobil" class="form-control" placeholder="Masukkan nama mobil" required>
                        </div>
                        <div class="mb-2">
                           <label for="tipe_mobil" class="form-label">Tipe Mobil</label>
                           <input type="text" name="tipe_mobil" id="tipe_mobil" class="form-control" placeholder="Masukkan tipe mobil" required>
                        </div>
                        <div class="mb-2">
                           <label for="merk_mobil" class="form-label">Merk Mobil</label>
                           <input type="text" name="merk_mobil" id="merk_mobil" class="form-control" placeholder="Masukkan merk mobil" required>
                        </div>
                        <div class="mb-2">
                           <label for="deskripsi" class="form-label">Deskripsi</label>
                           <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control" placeholder="Masukkan deskripsi mobil"></textarea>
                        </div>
                        <div class="mb-2">
                           <label for="stok" class="form-label">Stok</label>
                           <input type="number" name="stok" id="stok" class="form-control" placeholder="Masukkan stok mobil" required>
                        </div>
                        <div class="mb-2">
                           <label for="harga" class="form-label">Harga</label>
                           <input type="number" name="harga" id="harga" class="form-control" placeholder="Masukkan harga mobil" required>
                        </div>
